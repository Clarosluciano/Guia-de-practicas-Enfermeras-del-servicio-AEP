...
<head>
    ...
    <title>Sv. AEP bibliografía</title>
...
?>
    <header class="fix-header">
        <div class="header-items">
            <a href="https://www.fundacionheca.org.ar/hospital/" target="_blank">
                <img src="../assets/img/logo-heca-03.png" class="heca-logo">
            </a>
        </div>
        ...
        <nav class="nav hide-menu" id="nav">
            ...
            <ul class="nav-list">
                ...
                <li><a href="contador-visitas.html">Contador de visitas</a></li>
            </ul>
        </nav>
    </header>
    <main class="main">
    ...
    <footer class="footer">
        <div class="social-media-icons">
            ...
            <p class="footer-text">
                Copyright © 2023 Analía Vera. All rights reserved.
            </p>
        </div>
    </footer>
</body>
